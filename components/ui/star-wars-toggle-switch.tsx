...
const BB8Toggle = ({ isLight, onToggle }: BB8ToggleProps) => {
  // checked = dark/night (stars visible), unchecked = light/day (clouds visible)
  const isDark = !isLight;

  return (
    <StyledWrapper>
      <label className="bb8-toggle" title={`Switch to ${isLight ? "dark" : "light"} mode`}>
        <input
