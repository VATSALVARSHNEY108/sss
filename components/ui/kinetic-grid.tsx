  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = isLight
        ? {
            bg: "#f4f7fb",
            lineBase: { r: 13, g: 15, b: 18, a: 0.08 },
            lineActive: { r: 31, g: 111, b: 214, a: 0.85 },
            nodeBase: { r: 13, g: 15, b: 18, a: 0.15 },
            nodeActive: { r: 31, g: 111, b: 214, a: 1 },
            glow: "31,111,214",
            ripple: "31,111,214",
          }
        : globalColor === "monochrome"
          ? {
              ...
              lineActive: { r: 255, g: 255, b: 255, a: 0.85 },
              nodeBase: { r: 255, g: 255, b: 255, a: 0.15 },
      ...
      // Static background dot texture – very faint, just texture
